        ...
        <div class="container mt-5">
                @if (Route::has('login'))
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        @auth
                            <a href="{{ url('/index') }}" class="text-sm text-gray-700 underline">Administrar</a>
                        @else
            ...
            <div class="row"><!--contenedor para las cards-->
                ...
                @foreach($libros as $libro)
                    <div class="col-xs-12 col-md-6 pb-3 text-center">
                        <div class="card shadow bg-white rounded p-1">
                            <div class="card-body text-left">
                                <tr>
                                    ...
                                    <hr>
                                    <th>
                                        <a href="{{route('show',$libro->id)}}" class="btn btn-success pl-5 pr-5 ml-3 mb-2">Ver más</a> 
